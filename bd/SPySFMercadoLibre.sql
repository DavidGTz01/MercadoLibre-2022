...
DROP FUNCTION
    ...
    CREATE FUNCTION recaudacionPara (unidProducto INTEGER UNSIGNED,cotaSuperior DATETIME,cotaInferior DATETIME) RETURNS FLOAT READS SQL DATA BEGIN DECLARE resultado FLOAT;
